      ...
      <main class="portfolio-main">
        ...
        <section id="automations" class="chapter-section scroll-section reveal-on-scroll">
          <div class="feature-shell feature-automation">
            <div class="section-heading-row"><div><span class="section-eyebrow">Automation systems</span><h2 class="chapter-header">n8n Automations</h2></div></div>
        ...
        <Transition name="workflow-modal">
          <div v-if="selectedCaseStudy" class="workflow-modal-backdrop" @click.self="selectedCaseStudy = null">
            <section class="workflow-modal case-study-modal" role="dialog" aria-modal="true" :aria-label="`${selectedCaseStudy.title} case study`">
        ...
        <section id="connection" class="chapter-section scroll-section reveal-on-scroll">
          <div class="contact-wrapper">
            ...
            <h2 class="chapter-header">Let’s collaborate.</h2>
...
.origin-head,.section-heading-row { display:block; }.section-index { display:none; }.origin-head h2 { font-size:clamp(2.25rem,5vw,4.5rem); line-height:.98; }.origin-story,.origin-milestones,.competency-rail { margin-left:0; }.feature-shell>.chapter-subtitle { margin-left:0; }.section-heading-row { padding-top:1.15rem; border-top:1px solid var(--card-border); }.section-heading-row .chapter-header { font-size:clamp(2rem,4vw,3.35rem); letter-spacing:-.055em; }.contact-wrapper { padding:clamp(2.2rem,5vw,4.25rem); border-radius:0; background:transparent; box-shadow:none; color:var(--text-primary); border-top:1px solid var(--card-border); border-bottom:1px solid var(--card-border); }.contact-wrapper::after { display:none; }.contact-wrapper .section-eyebrow { color:var(--accent-purple); }.contact-wrapper .chapter-header { color:var(--text-primary); font-size:clamp(2.2rem,4.5vw,3.8rem); letter-spacing:-.055em; line-height:1; }.contact-wrapper .chapter-subtitle { color:var(--text-secondary); }.contact-wrapper .contact-details h3,.contact-wrapper .detail-link,.contact-wrapper .form-group label { color:var(--text-primary); }.contact-wrapper .contact-details p,.contact-wrapper .detail-item { color:var(--text-secondary); }.contact-wrapper .form-input { color:var(--text-primary); border-color:var(--card-border); background:rgba(255,255,255,.55); }.contact-wrapper .form-input::placeholder { color:var(--text-secondary); }.contact-wrapper .submit-btn { color:#fff; background:var(--accent-purple); }.dark-theme .contact-wrapper { background:transparent; box-shadow:none; border-color:rgba(148,163,184,.24); }.dark-theme .contact-wrapper .form-input { color:#f8fafc; background:rgba(30,41,59,.78); border-color:rgba(148,163,184,.28); }.dark-theme .contact-wrapper .form-input::placeholder { color:#94a3b8; }.dark-theme .contact-wrapper .submit-btn { color:#fff; background:#ea580c; }
.case-study-link { width:100%; display:flex; align-items:center; justify-content:space-between; margin-top:1rem; padding:0; border:0; color:var(--text-primary); background:transparent; font:inherit; font-size:.78rem; font-weight:800; cursor:pointer; text-align:left; }.case-study-link span { color:var(--accent-purple); font-size:1rem; }.case-study-link:hover { color:var(--accent-purple); }.case-study-modal { width:min(780px,100%); }.case-study-grid { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:.8rem; margin:2rem 0 1.25rem; }.case-study-grid article { padding:1rem; border:1px solid rgba(255,255,255,.15); border-radius:14px; background:rgba(0,0,0,.15); }.case-study-grid article:last-child { grid-column:1/-1; }.case-study-grid span { display:block; margin-bottom:.5rem; color:#fdba74; font-size:.65rem; font-weight:900; letter-spacing:.1em; text-transform:uppercase; }.case-study-grid p { color:#e7e5e4; font-size:.82rem; line-height:1.55; }.case-study-tags { display:flex; flex-wrap:wrap; gap:.42rem; }.case-study-tags b { padding:.35rem .5rem; border-radius:7px; color:#fed7aa; background:rgba(251,146,60,.13); border:1px solid rgba(251,146,60,.28); font-size:.68rem; }.case-study-live { display:inline-flex; gap:.55rem; align-items:center; color:#fdba74; font-size:.8rem; font-weight:800; text-decoration:none; }.case-study-live:hover { color:#fff; } .dark-theme .case-study-link { color:#f8fafc; } @media(max-width:600px){.case-study-grid{grid-template-columns:1fr}.case-study-grid article:last-child{grid-column:auto}}
.origin-milestones { position:relative; gap:1px; padding:1px; border:0; overflow:hidden; background:linear-gradient(100deg,rgba(234,88,12,.42),rgba(217,119,6,.08),rgba(234,88,12,.35)); }.origin-milestones::before { content:''; position:absolute; z-index:2; left:-20%; top:0; width:22%; height:2px; background:linear-gradient(90deg,transparent,#ea580c,transparent); box-shadow:0 0 16px #fb923c; animation:milestoneSignal 5s ease-in-out infinite; }.origin-milestones article,.origin-milestones article:last-child { min-height:225px; position:relative; display:flex; flex-direction:column; padding:1.35rem; border:0; background:linear-gradient(145deg,rgba(255,255,255,.84),rgba(255,250,245,.48)); transition:transform .32s cubic-bezier(.2,.8,.2,1),background .32s ease; }.origin-milestones article:nth-child(2) { background:linear-gradient(145deg,rgba(255,248,240,.9),rgba(255,255,255,.52)); }.origin-milestones article:nth-child(3) { background:linear-gradient(145deg,rgba(255,247,237,.98),rgba(255,252,248,.62)); }.origin-milestones article:hover { z-index:3; transform:translateY(-9px); background:#fff; box-shadow:0 20px 35px rgba(112,54,5,.12); }.milestone-top { display:flex; justify-content:space-between; align-items:center; }.milestone-top>span { margin:0; }.milestone-top i { width:34px; height:34px; display:grid; place-items:center; border-radius:10px; color:#ea580c; background:rgba(234,88,12,.1); }.milestone-top svg { width:19px; height:19px; }.origin-milestones h3 { margin:2.1rem 0 .6rem; }.origin-milestones p { max-width:290px; }.origin-milestones small { margin-top:auto; padding-top:1.25rem; color:#9a3412; font-size:.67rem; font-weight:800; letter-spacing:.08em; text-transform:uppercase; }.dark-theme .origin-milestones { background:linear-gradient(100deg,rgba(251,146,60,.55),rgba(148,163,184,.15),rgba(251,146,60,.4)); }.dark-theme .origin-milestones article,.dark-theme .origin-milestones article:nth-child(2),.dark-theme .origin-milestones article:nth-child(3) { background:linear-gradient(145deg,#172033,#111827); }.dark-theme .origin-milestones article:hover { background:#202d43; box-shadow:0 20px 35px rgba(0,0,0,.34); }.dark-theme .origin-milestones small { color:#fdba74; } @keyframes milestoneSignal { 0%,30% { transform:translateX(0);opacity:0; } 38%,62% { opacity:1; } 70%,100% { transform:translateX(560%);opacity:0; } } @media(max-width:760px){.origin-milestones{gap:1px}.origin-milestones article,.origin-milestones article:last-child{min-height:190px;padding:1.15rem}.origin-milestones h3{margin:1.45rem 0 .5rem}}

/* Interactive selected-work showreel: one project at a time, with intentional focus. */
.showcase-shell { display:grid; grid-template-columns:minmax(230px,.62fr) minmax(0,1.7fr); overflow:hidden; margin-top:1.8rem; border:1px solid rgba(89,47,22,.42); border-radius:28px; color:#fffaf5; background:radial-gradient(circle at 84% 5%,rgba(249,115,22,.26),transparent 27%),linear-gradient(135deg,#17110e 0%,#2a160c 54%,#19110e 100%); box-shadow:0 28px 70px rgba(89,47,22,.21); }.showcase-nav { display:flex; flex-direction:column; gap:.25rem; padding:1.45rem; border-right:1px solid rgba(255,255,255,.13); background:rgba(0,0,0,.16); }.showcase-nav>p { display:flex; justify-content:space-between; margin:0 0 1.25rem; color:#fdba74; font-size:.62rem; font-weight:900; letter-spacing:.12em; }.showcase-nav>p span { color:#fed7aa; }.showcase-nav button { width:100%; display:grid; grid-template-columns:30px minmax(0,1fr) 18px; gap:.65rem; align-items:center; padding:1rem .7rem; border:1px solid transparent; border-radius:14px; color:#d6d3d1; background:transparent; font:inherit; text-align:left; cursor:pointer; transition:background .25s ease,border-color .25s ease,transform .25s cubic-bezier(.2,.8,.2,1); }.showcase-nav button:hover { color:#fff; transform:translateX(4px); background:rgba(255,255,255,.06); }.showcase-nav button.active { color:#fff; border-color:rgba(251,146,60,.55); background:linear-gradient(90deg,rgba(234,88,12,.27),rgba(251,146,60,.08)); }.showcase-nav em { color:#fb923c; font-size:.66rem; font-style:normal; font-weight:900; }.showcase-nav b,.showcase-nav small { display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.showcase-nav b { font-size:.86rem; }.showcase-nav small { margin-top:.28rem; color:#d6d3d1; font-size:.61rem; letter-spacing:.04em; text-transform:uppercase; }.showcase-nav i { color:#fdba74; font-style:normal; opacity:0; transition:opacity .2s ease; }.showcase-nav button.active i,.showcase-nav button:hover i { opacity:1; }.showcase-stage { min-width:0; padding:clamp(1.1rem,2.2vw,1.8rem); }.showcase-screen { position:relative; height:clamp(285px,34vw,475px); overflow:hidden; border:1px solid rgba(255,255,255,.18); border-radius:18px; background:#111; box-shadow:0 18px 45px rgba(0,0,0,.3); }.showcase-live-preview { position:relative; width:100%; height:100%; overflow:hidden; }.showcase-live-preview iframe { width:147%; height:147%; border:0; background:#fff; transform:scale(.68); transform-origin:top left; }.showcase-live-preview::after { content:''; position:absolute; inset:0; pointer-events:none; background:linear-gradient(180deg,transparent 62%,rgba(0,0,0,.62)); }.showcase-live-preview>span,.showcase-open { position:absolute; z-index:1; bottom:13px; font-size:.65rem; font-weight:900; letter-spacing:.1em; }.showcase-live-preview>span { right:15px; color:#fff; }.showcase-open { left:14px; padding:.5rem .65rem; border:1px solid rgba(255,255,255,.3); border-radius:999px; color:#fff; background:rgba(0,0,0,.42); text-decoration:none; transition:background .2s ease,transform .2s ease; }.showcase-open:hover { color:#1c1917; background:#fb923c; transform:translateY(-2px); }.showcase-assistant { height:100%; min-height:0; }.showcase-assistant .assistant-demo-body { padding:clamp(1.25rem,3vw,2.2rem); font-size:clamp(.95rem,1.4vw,1.2rem); }.showcase-assistant form { padding:1.1rem; }.showcase-copy { padding:1.3rem .35rem .2rem; }.showcase-copy>span { color:#fdba74; font-size:.65rem; font-weight:900; letter-spacing:.11em; text-transform:uppercase; }.showcase-copy h3 { margin:.5rem 0 .55rem; color:#fff; font-size:clamp(1.55rem,2.8vw,2.45rem); letter-spacing:-.05em; line-height:1; }.showcase-copy p { max-width:700px; margin:0; color:#e7e5e4; font-size:.92rem; line-height:1.6; }.showcase-copy>div { display:flex; justify-content:space-between; align-items:center; gap:1rem; margin-top:1.25rem; padding-top:.9rem; border-top:1px solid rgba(255,255,255,.14); }.showcase-copy small { color:#fed7aa; font-size:.69rem; font-weight:800; }.showcase-copy button { border:0; padding:0; color:#fff; background:transparent; font:inherit; font-size:.77rem; font-weight:900; cursor:pointer; }.showcase-copy button i { margin-left:.35rem; color:#fb923c; font-style:normal; font-size:1rem; }.showcase-copy button:hover { color:#fdba74; }.showcase-copy.violet>span,.showcase-copy.violet button i { color:#c4b5fd; }.showcase-copy.blue>span,.showcase-copy.blue button i { color:#93c5fd; }.showcase-copy.green>span,.showcase-copy.green button i { color:#6ee7b7; }.showcase-swap-enter-active,.showcase-swap-leave-active { transition:opacity .22s ease,transform .22s ease; }.showcase-swap-enter-from { opacity:0; transform:translateY(12px) scale(.985); }.showcase-swap-leave-to { opacity:0; transform:translateY(-8px) scale(.99); }.dark-theme .showcase-shell { border-color:rgba(148,163,184,.27); background:radial-gradient(circle at 84% 5%,rgba(234,88,12,.18),transparent 27%),linear-gradient(135deg,#101827,#17130f); }.dark-theme .showcase-nav { background:rgba(2,6,23,.37); }.dark-theme .showcase-nav button.active { border-color:rgba(251,146,60,.65); background:linear-gradient(90deg,rgba(234,88,12,.32),rgba(30,41,59,.15)); } @supports (animation-timeline:view()) { .showcase-shell { animation:showcaseArrival linear both; animation-timeline:view(); animation-range:entry 7% cover 36%; } } @keyframes showcaseArrival { from { opacity:.18; transform:translateY(70px) scale(.97); } to { opacity:1; transform:translateY(0) scale(1); } } @media(max-width:760px){.showcase-shell{grid-template-columns:1fr;border-radius:20px}.showcase-nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.35rem;padding:1rem;border-right:0;border-bottom:1px solid rgba(255,255,255,.13)}.showcase-nav>p{grid-column:1/-1;margin:0 0 .35rem}.showcase-nav button{grid-template-columns:23px minmax(0,1fr);padding:.72rem .5rem}.showcase-nav button i{display:none}.showcase-nav b{font-size:.73rem}.showcase-nav small{font-size:.53rem}.showcase-stage{padding:1rem}.showcase-screen{height:315px}.showcase-copy{padding:1.15rem .1rem .15rem}.showcase-copy>div{align-items:flex-start;flex-direction:column;gap:.6rem}} @media(prefers-reduced-motion:reduce){.showcase-shell{animation:none}.showcase-swap-enter-active,.showcase-swap-leave-active{transition:none}}
...
.hero-image-frame.hero-portrait-cutout { width:330px; height:330px; overflow:hidden; border:0; border-radius:0; background:transparent; box-shadow:none; animation:none; isolation:isolate; }.hero-portrait-cutout::before,.hero-portrait-cutout::after { display:none; }.hero-portrait-cutout .hero-avatar { position:static; width:100%; height:100%; object-fit:cover; object-position:center; filter:none; -webkit-mask-image:none; mask-image:none; }.dark-theme .hero-image-frame.hero-portrait-cutout { border:0; background:transparent; box-shadow:none; } @media(max-width:760px){.hero-image-frame.hero-portrait-cutout{width:250px;height:250px;border-radius:0;}}

/* Fixed-size portrait rotation: the frame and the facts below never move. */
.hero-portrait-cutout .hero-rotating-photo { position:absolute; inset:0; width:100%; height:100%; opacity:0; object-fit:contain; object-position:center bottom; mix-blend-mode:normal; filter:drop-shadow(0 16px 18px rgba(69,38,13,.14)); animation:heroPhotoCycle 15s ease-in-out infinite; will-change:opacity; }.hero-portrait-cutout .hero-photo-graduation { animation-delay:0s; }.hero-portrait-cutout .hero-photo-barong { animation-delay:-5s; }.hero-portrait-cutout .hero-photo-portrait { animation-delay:-10s; } @keyframes heroPhotoCycle { 0%,30% { opacity:1; } 33.34%,96.66% { opacity:0; } 100% { opacity:1; } } .dark-theme .hero-portrait-cutout .hero-rotating-photo { mix-blend-mode:normal; filter:drop-shadow(0 18px 22px rgba(0,0,0,.32)); } @media(prefers-reduced-motion:reduce){.hero-portrait-cutout .hero-rotating-photo{animation:none;}.hero-portrait-cutout .hero-photo-graduation{opacity:1;}.hero-portrait-cutout .hero-photo-barong,.hero-portrait-cutout .hero-photo-portrait{display:none;}}
